...
const cauHoiList = [
  {
     id: "q1",
    question: "Giới hạn lim(x→+∞) (3x - 2)/(x + 5) bằng?",
    options: {
      A: "3",
      B: "2",
      C: "1",
  ...
  {
    id: "q5",
    question: "Số phức z = -2 + 2i có môđun là?",
    options: {
      A: "2√2",
      B: "2",
      C: "4",
  ...
  {
    id: "q7",
    question: "Giới hạn lim(x→-∞) e^x bằng?",
    options: {
      A: "0",
      B: "1",
      C: "+∞",
  ...
  {
    id: "q11",
    question: "Tập xác định của hàm y = √(x-3) là?",
    options: {
      A: "[3,+∞)",
      B: "(-∞,3)",
      C: "R",
  ...
  {
    id: "q14",
    question: "Tổng các nghiệm của x^2 + 3x - 4 = 0 bằng?",
    options: {
      A: "-3",
      B: "4",
      C: "3",
  ...
  {
    id: "q16",
    question: "Giới hạn lim(x→0) (1 - e^x)/x bằng?",
    options: {
      A: "-1",
      B: "0",
      C: "1",
  ...
  {
    id: "q17",
    question: "Đạo hàm của log_a x (a>0, a≠1) là?",
    options: {
      A: "1/(x ln a)",
      B: "1/x",
      C: "ln a/x",
  ...
  {
    id: "q18",
    question: "Tích phân ∫ x^2 dx bằng?",
    options: {
      A: "x^3/3 + C",
      B: "x^3 + C",
      C: "2x + C",
  ...
  {
    id: "q20",
    question: "Phương trình log_5 x = 2 có nghiệm là?",
    options: {
      A: "x = 25",
      B: "x = 5",
      C: "x = 2",
  ...
  {
    id: "q21",
    question: "Giới hạn lim(x→+∞) (x - 1)/(x + 2) bằng?",
    options: {
      A: "1",
      B: "0",
      C: "∞",
  ...
  {
    id: "q25",
    question: "Số phức z = 5i có phần thực là?",
    options: {
      A: "0",
      B: "5",
      C: "-5",
  ...
  {
    id: "q27",
    question: "Giới hạn lim(x→0) tan(3x)/x bằng?",
    options: {
      A: "3",
      B: "1",
      C: "0",
  ...
  {
    id: "q29",
    question: "Tập xác định của ln(x+1) là?",
    options: {
      A: "(-1;+∞)",
      B: "(0;+∞)",
      C: "[0;+∞)",
  ...
  {
    id: "q31",
    question: "Giới hạn lim(x→0) (ln(1+x))/x bằng?",
    options: {
      A: "1",
      B: "0",
      C: "∞",
  ...
  {
    id: "q34",
    question: "Tích phân ∫ 1/cos^2 x dx bằng?",
    options: {
      A: "tan x + C",
      B: "cot x + C",
      C: "-tan x + C",
  ...
  {
    id: "q35",
    question: "Môđun của số phức z = 1 - i là?",
    options: {
      A: "√2",
      B: "2",
      C: "1",
  ...
  {
    id: "q37",
    question: "Giới hạn lim(x→+∞) (x^3 + 1)/(2x^3 - 5) bằng?",
    options: {
      A: "1/2",
      B: "0",
      C: "∞",
  ...
  {
    id: "q38",
    question: "Phương trình log_4(x) = 3 có nghiệm là?",
    options: {
      A: "x = 64",
      B: "x = 12",
      C: "x = 7",
  ...
  {
    id: "q40",
    question: "Giới hạn lim(x→0) (1 - cos 2x)/x^2 bằng?",
    options: {
      A: "2",
      B: "0",
      C: "1",
